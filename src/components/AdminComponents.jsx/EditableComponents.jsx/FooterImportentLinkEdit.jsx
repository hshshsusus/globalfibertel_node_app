...
const FooterImportentLinksEdit = () => {
    ...
    const handleSave = async (id) => {
        ...
        try {
            ...
            console.log(updated)
            const res = await axios.put(BASE_URL + "/admin/home/footer/importentlink/edit/" + id, updated, { withCredentials: true })
            console.log(res)
            setEditingId(null);
        } catch (error) {
            console.log(error)
...
export default FooterImportentLinksEdit;