...
const FooterCompanyDetEdit = () => {
    ...
    const handleSave = async (id) => {
        ...
        try {
            ...
            console.log(updated)
            const res = await axios.put(BASE_URL + "/admin/home/footer/companyinfo/edit/" + id, updated, { withCredentials: true })
            console.log(res)
            setEditingId(null);
        } catch (error) {
            console.log(error)
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {Object.keys(service).map((eachField) => {
                                const isTextArea = eachField === "address";
                                const isHiddenField =
                                    eachField === "id" ||
...
export default FooterCompanyDetEdit;