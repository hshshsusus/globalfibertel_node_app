...
const HomeFAQEdit = () => {
    ...
    const handleSave = async (id) => {
        try {
            const updatedFAQ = faqData.find(item => item.id === id);
            const res = await axios.put(BASE_URL + "/admin/homepage/faqs/edit/" + id, updatedFAQ, { withCredentials: true })
